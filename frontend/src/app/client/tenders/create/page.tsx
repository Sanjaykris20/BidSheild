...
export default function ClientCreateTenderPage() {
  ...
  const [requiredDocs, setRequiredDocs] = useState([
    { id: 'req_gst', name: 'GST Certificate', category: 'Statutory / Tax', weight: 15, checked: true },
    { id: 'req_pan', name: 'PAN Card', category: 'Statutory / Tax', weight: 15, checked: true },
    { id: 'req_msme', name: 'MSME / Udyam Registration', category: 'Statutory / MSME', weight: 15, checked: true },
    { id: 'req_mse', name: 'MSE (Micro & Small Enterprise) Certificate', category: 'Statutory / MSME', weight: 10, checked: false },
    { id: 'req_mii', name: 'Local Content Declaration', category: 'Compliance / MII', weight: 20, checked: true },
    { id: 'req_oem', name: 'OEM Authorization Form (MAF)', category: 'Technical / OEM', weight: 15, checked: false },
    { id: 'req_epfo', name: 'EPFO Compliance Certificate', category: 'Statutory / Labour', weight: 10, checked: false },
    { id: 'req_esic', name: 'ESIC Compliance Certificate', category: 'Statutory / Labour', weight: 10, checked: false },
    { id: 'req_itr', name: 'Income Tax Returns (3 Years)', category: 'Statutory / Tax', weight: 15, checked: true },
    ...
    { id: 'req_iso', name: 'ISO 9001 Quality Certificate', category: 'Technical / Quality', weight: 15, checked: false },
    { id: 'req_debarment', name: 'Non-Debarment Declaration', category: 'Compliance / CVC', weight: 15, checked: false },
    { id: 'req_scst', name: 'SC/ST Caste Certificate', category: 'Statutory / Social', weight: 20, checked: true },
